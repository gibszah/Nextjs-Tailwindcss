  ...
  return (
    <div className="fixed transform -translate-y-36 top-52 -right-48">
      <div className="relative">
        <span className="inline-block border border-gray-200 rounded-full w-96 h-96">
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="inline-block border-2 border-gray-200 border-solid rounded-full w-80 h-80">
              <div className="absolute inset-0 flex items-center justify-center">
